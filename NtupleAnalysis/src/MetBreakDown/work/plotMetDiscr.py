...
hNames = [
    "MET_0leptonFromW_Et",
    "MET_1_more_leptonFromW_Et",

    "MET_0leptonFromB_Et",
    "MET_1_more_leptonFromB_Et",

    "MET_leptons_0FromB_0FromW_Et",
    "MET_leptons_1_more_FromB_0FromW_Et",
    "MET_leptons_0FromB_1_more_FromW_Et",
    "MET_leptons_1_more_FromB_1_more_FromW_Et",
]
...
def main(opts):
    ...
    for h_prefix in ["reco", "gen"]:
        ...
        inclusiveHisto, fixedHistos = GetHistosForPlotter(datasetsMgr_fixed, h_prefix + "MET_Et", **kwargs_fixed)

...
#    for counter, hName in enumerate(hNames):
    if True:
        ...
        savePath, saveName = GetSavePathAndName(saveNamePrefix + "nLeptons", **kwargs)
...
if __name__ == "__main__":
    ...
    for var in ["Et"]:#, "Phi"]:
        ...
        hNames.append("recoMET_leptons_0FromB_0FromW_" + var)
        hNames.append("recoMET_1leptons_" + var)
        hNames.append("recoMET_2_more_leptons_" + var)

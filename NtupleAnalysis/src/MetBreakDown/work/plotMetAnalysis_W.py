...
_hLegends = ["Inclusive","0 leptons from W", "1 lepton from W", "2+ leptons from W"]
...
#    for counter, hName in enumerate(hNames):
    if True:
        ...
        savePath, saveName = GetSavePathAndName(saveNamePrefix + "nWDecays", **kwargs)
...
if __name__ == "__main__":
    ...
    for var in ["Et"]:#, "Phi"]:
        ...
        hNames.append("recoMET_0leptonFromW_" + var)
        hNames.append("recoMET_1leptonFromW_" + var)
        hNames.append("recoMET_2_more_leptonFromW_" + var)

...
kwargs = {
    ...
    "rmDataset"      : ["ChargedHiggs_HplusTB_HplusToTB_M_220", "ChargedHiggs_HplusTB_HplusToTB_M_250", "ChargedHiggs_HplusTB_HplusToTB_M_300", "ChargedHiggs_HplusTB_HplusToTB_M_350", "ChargedHiggs_HplusTB_HplusToTB_M_400", "ChargedHiggs_HplusTB_HplusToTB_M_500", "TT"], #["QCD"],
...
_hLegends = ["Inclusive","0 leptons from B", "1 lepton from B", "2+ leptons from B"]
...
#    for counter, hName in enumerate(hNames):
    if True:
        ...
        savePath, saveName = GetSavePathAndName(saveNamePrefix + "nBDecays", **kwargs)
...
if __name__ == "__main__":
    ...
    hRefNames  = []
    for var in ["Et"]:#, "Phi"]:
        hRefNames.append("recoMET_" + var)
    
        hNames.append("recoMET_0leptonFromB_" + var)
        hNames.append("recoMET_1leptonFromB_" + var)
        hNames.append("recoMET_2_more_leptonFromB_" + var)

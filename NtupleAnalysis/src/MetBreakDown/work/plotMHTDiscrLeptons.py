...
kwargs = {
    ...
    "savePath"       : os.getcwd() + "/plots/mhtBreakdownRatio/",
...
hStyles = ["TT", "QCD"]
hSaveNames = ["MHT_nWDecays", "MHT_nBDecays", "MHT_nLeptons"]
#================================================================================================
# Main
#================================================================================================
def main(opts):
    ...
    for h_prefix in ["reco", "gen"]:
        ...
        inclusiveHisto, fixedHistos = GetHistosForPlotter(datasetsMgr, h_prefix + "MHT", **kwargs)
